// ****************************************************************************
//
//  $Id: mexInterface_AlgDirICP_PIMLOP_Mesh.cpp, v0.1 Exp $
//
//  Description:
//	        
//
...
#include "mexInterface_AlgDirICP_PIMLOP_Mesh.h"
...
{ // create new class instance
  ...
  plhs[0] = convertPtr2Mat < mexInterface_AlgDirICP_PIMLOP_Mesh >
    (new mexInterface_AlgDirICP_PIMLOP_Mesh);
}
...
{ // delete class instance
  ...
  destroyObject<mexInterface_AlgDirICP_PIMLOP_Mesh>(prhs[1]);
}
...
void CommandInitialize(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  mexInterface_AlgDirICP_PIMLOP_Mesh& obj =
    *convertMat2Ptr<mexInterface_AlgDirICP_PIMLOP_Mesh>(prhs[1]);
  ...
  obj.pAlg = new algDirICP_PIMLOP_Mesh(
    pPDTree, samplePts, sampleNorms2d,
    Rx_plane, k, M);
}
...
void CommandICP_ComputeMatches(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  algDirICP_PIMLOP_Mesh& alg = *obj.pAlg;
