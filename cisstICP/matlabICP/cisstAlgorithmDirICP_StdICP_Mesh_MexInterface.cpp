// ****************************************************************************
//
//  $Id: cisstAlgorithmDirICP_StdICP_Mesh_MexInterface.cpp, v0.1 Exp $
//
//  Description:
//	        
//
...
#include "cisstAlgorithmDirICP_StdICP_Mesh_MexInterface.h"
...
{ // create new class instance
  ...
  plhs[0] = convertPtr2Mat < cisstAlgorithmDirICP_StdICP_Mesh_MexInterface >
    (new cisstAlgorithmDirICP_StdICP_Mesh_MexInterface);
}
...
{ // delete class instance
  ...
  destroyObject<cisstAlgorithmDirICP_StdICP_Mesh_MexInterface>(prhs[1]);
}
...
void CommandInitialize(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  cisstAlgorithmDirICP_StdICP_Mesh_MexInterface& obj =
    *convertMat2Ptr<cisstAlgorithmDirICP_StdICP_Mesh_MexInterface>(prhs[1]);
  ...
  double kfactor = 1.0;
  obj.pAlg = new cisstAlgorithmDirICP_StdICP_Mesh( pCovTree, samplePts, sampleNorms );
}
...
void CommandICP_ComputeMatches(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  cisstAlgorithmDirICP_StdICP_Mesh& alg = *obj.pAlg;
