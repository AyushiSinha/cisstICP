// ****************************************************************************
//
//  $Id: cisstAlgorithmICP_StdICP_Mesh_MexInterface.cpp, v0.1 Exp $
//
//  Description:
//	        
//
...
#include "cisstAlgorithmICP_StdICP_Mesh_MexInterface.h"
...
{ // create new class instance
  ...
  plhs[0] = convertPtr2Mat < cisstAlgorithmICP_StdICP_Mesh_MexInterface >
    (new cisstAlgorithmICP_StdICP_Mesh_MexInterface);
}
...
{ // delete class instance
  ...
  destroyObject<cisstAlgorithmICP_StdICP_Mesh_MexInterface>(prhs[1]);
}
...
void CommandInitialize(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  cisstAlgorithmICP_StdICP_Mesh_MexInterface& obj =
    *convertMat2Ptr<cisstAlgorithmICP_StdICP_Mesh_MexInterface>(prhs[1]);
  ...
  obj.pAlg = new cisstAlgorithmICP_StdICP_Mesh(pCovTree, samplePts);
}
...
void CommandICP_ComputeMatches(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  cisstAlgorithmICP_StdICP_Mesh& alg = *obj.pAlg;
