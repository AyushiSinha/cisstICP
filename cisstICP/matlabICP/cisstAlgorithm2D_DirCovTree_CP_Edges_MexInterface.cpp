// ****************************************************************************
//
//  $Id: cisstAlgorithm2D_DirCovTree_CP_Edges_MexInterface.cpp, v0.1 Exp $
//
//  Description:
//	        
//
...
#include "cisstAlgorithm2D_DirCovTree_CP_Edges_MexInterface.h"
...
{ // create new class instance
  ...
  plhs[0] = convertPtr2Mat < cisstAlgorithm2D_DirCovTree_CP_Edges_MexInterface >
    (new cisstAlgorithm2D_DirCovTree_CP_Edges_MexInterface);
}
...
{ // delete class instance
  ...
  destroyObject<cisstAlgorithm2D_DirCovTree_CP_Edges_MexInterface>(prhs[1]);
}
...
void CommandInitialize(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  cisstAlgorithm2D_DirCovTree_CP_Edges_MexInterface& obj =
    *convertMat2Ptr<cisstAlgorithm2D_DirCovTree_CP_Edges_MexInterface>(prhs[1]);
  ...
  obj.pAlg = new cisstAlgorithm2D_DirCovTree_CP_Edges(obj.pDirTree);
}
...
void CommandComputeMatches(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  cisstAlgorithm2D_DirCovTree_CP_Edges& alg = *obj.pAlg;
...
void cisstAlgorithm2D_DirCovTree_CP_Edges_MexInterface::ComputeMatches()
{
