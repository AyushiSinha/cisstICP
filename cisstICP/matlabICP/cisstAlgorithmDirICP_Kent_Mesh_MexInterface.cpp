// ****************************************************************************
//
//  $Id: cisstAlgorithmDirICP_Kent_Mesh_MexInterface.cpp, v0.1 Exp $
//
//  Description:
//	        
//
...
#include "cisstAlgorithmDirICP_Kent_Mesh_MexInterface.h"
...
{ // create new class instance
  ...
  plhs[0] = convertPtr2Mat < cisstAlgorithmDirICP_Kent_Mesh_MexInterface >
    (new cisstAlgorithmDirICP_Kent_Mesh_MexInterface);
}
...
{ // delete class instance
  ...
  destroyObject<cisstAlgorithmDirICP_Kent_Mesh_MexInterface>(prhs[1]);
}
...
void CommandInitialize(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  cisstAlgorithmDirICP_Kent_Mesh_MexInterface& obj =
    *convertMat2Ptr<cisstAlgorithmDirICP_Kent_Mesh_MexInterface>(prhs[1]);
  ...
  //  B(i) = E(i) * k(i) / 2.0;
  //}
  cisstAlgorithmDirICP_Kent::PARAM_EST_TYPE dynParamEstType;
  switch (dynamicParamEst)
  {
  case 0:
    dynParamEstType = cisstAlgorithmDirICP_Kent::PARAMS_FIXED;
    break;
  case 1:
    dynParamEstType = cisstAlgorithmDirICP_Kent::PARAMS_DYN_THRESH;
    break;
  case 2:
    dynParamEstType = cisstAlgorithmDirICP_Kent::PARAMS_FIXED_1stITER_POS;
    break;
  default:
  ...
  obj.pAlg = new cisstAlgorithmDirICP_Kent_Mesh(
    pCovTree, samplePts, sampleNorms, k, E, L, M, dynParamEstType);
}
...
void CommandICP_ComputeMatches(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  cisstAlgorithmDirICP_Kent_Mesh& alg = *obj.pAlg;
