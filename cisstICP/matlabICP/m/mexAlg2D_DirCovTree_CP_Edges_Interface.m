classdef mexAlg2D_DirCovTree_CP_Edges_Interface < handle
% MATLAB class wrapper for C++ mex library
  ...
  methods
    ...
    function this = mexAlg2D_DirCovTree_CP_Edges_Interface()
      this.h = mexAlg2D_DirCovTree_CP_Edges('new');
    end

    %% Destructor - Destroy the C++ class instance
    function delete(this)
      mexAlg2D_DirCovTree_CP_Edges('delete', this.h);
    end
    ...
    function Initialize( this, edgesV1, edgesV2, edgesNorm, ...
      ...
      mexAlg2D_DirCovTree_CP_Edges('Initialize',this.h, ...
    ...
    function [matchPts2D, matchNorms2D, matchPts3D, matchDatums] = ...
      ...
      if exist('matchDatumsInit','var') && ~isempty(matchDatumsInit)
        [matchPts2D, matchNorms2D, matchPts3D, matchDatums] = ...
          mexAlg2D_DirCovTree_CP_Edges('ComputeMatches', this.h, ...
