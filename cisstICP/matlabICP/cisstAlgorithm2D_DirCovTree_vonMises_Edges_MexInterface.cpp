// ****************************************************************************
//
//  $Id: cisstAlgorithm2D_DirCovTree_vonMises_Edges_MexInterface.cpp, v0.1 Exp $
//
//  Description:
//	        
//
...
#include "cisstAlgorithm2D_DirCovTree_vonMises_Edges_MexInterface.h"

// debug
//#define ValidateCovTreeSearch

#ifdef ValidateCovTreeSearch
std::ofstream validFS("./debugCovTreeSearchValidation.txt");
vct2 validPoint;
vct2 validNorm;
int  validDatum;
double validDist;
...
{ // create new class instance
  ...
  plhs[0] = convertPtr2Mat < cisstAlgorithm2D_DirCovTree_vonMises_Edges_MexInterface >
    (new cisstAlgorithm2D_DirCovTree_vonMises_Edges_MexInterface);
}
...
{ // delete class instance
  ...
  destroyObject<cisstAlgorithm2D_DirCovTree_vonMises_Edges_MexInterface>(prhs[1]);
}
...
void CommandInitialize(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  cisstAlgorithm2D_DirCovTree_vonMises_Edges_MexInterface& obj =
    *convertMat2Ptr<cisstAlgorithm2D_DirCovTree_vonMises_Edges_MexInterface>(prhs[1]);
  ...
  obj.pDirTree = new cisstDirCovTree2D_Edges(
  ...
  obj.pAlg = new cisstAlgorithm2D_DirCovTree_vonMises_Edges(obj.pDirTree);
...
void CommandComputeMatches(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  cisstAlgorithm2D_DirCovTree_vonMises_Edges& alg = *obj.pAlg;
...
void cisstAlgorithm2D_DirCovTree_vonMises_Edges_MexInterface::ComputeMatches()
{
  ...
  for (unsigned int s = 0; s < nSamples; s++)
  {
    ...
    if (validDatum != matchDatums.Element(s))
    {
      ...
      if (searchError > doubleEps)
      {
        ...
        cisstDirCovTree2DNode *termNode = 0;
