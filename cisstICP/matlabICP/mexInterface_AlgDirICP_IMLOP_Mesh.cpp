// ****************************************************************************
//
//  $Id: mexInterface_AlgDirICP_IMLOP_Mesh.cpp, v0.1 Exp $
//
//  Description:
//	        
//
...
#include "mexInterface_AlgDirICP_IMLOP_Mesh.h"
...
{ // create new class instance
  ...
  plhs[0] = convertPtr2Mat < mexInterface_AlgDirICP_IMLOP_Mesh >
    (new mexInterface_AlgDirICP_IMLOP_Mesh);
}
...
{ // delete class instance
  ...
  destroyObject<mexInterface_AlgDirICP_IMLOP_Mesh>(prhs[1]);
}
...
void CommandInitialize(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  mexInterface_AlgDirICP_IMLOP_Mesh& obj =
    *convertMat2Ptr<mexInterface_AlgDirICP_IMLOP_Mesh>(prhs[1]);
...
void CommandICP_ComputeMatches(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  algDirICP_IMLOP_Mesh& alg = *obj.pAlg;
