classdef algDirICP_Kent < algICP
...
methods
  ...
  function Initialize( this, ...
    ...
    % Mex objects
    if (bTargetAsMesh)
      utlDebugMsg( this.bEnableDebug,'Creating mex object: mexAlgDirICP_Kent_Mesh_Interface...\n')
      this.mexAlg_Kent = mexAlgDirICP_Kent_Mesh_Interface();
