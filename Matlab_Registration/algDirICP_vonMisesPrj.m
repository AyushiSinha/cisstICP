classdef algDirICP_vonMisesPrj < algICP
...
methods
  ...
  %% Constructor
  function [this] = algDirICP_vonMisesPrj()
  end
  ...
  function Initialize( this, ...
    ...
    % Mex objects
    if (bTargetAsMesh)
      utlDebugMsg( this.bEnableDebug,'Creating mex object: mexAlgICP_vonMisesPrj_Mesh...\n')
      this.mexAlg_vonMisesPrj = mexAlgDirICP_vonMisesPrj_Mesh_Interface();
